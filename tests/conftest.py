...
def sample_data() -> pd.DataFrame:
    ...
    data = {
        ...
        'amount': ['$100.00', '$5000.00', '$200000.00', '$50.00', '$10000.00',
                   '$150000.00', '$300.00', '$75.00', '$1000.00', '$25000.00'],
        # Faire varier use_chip pour créer différents types
        'use_chip': ['Chip Transaction', 'Swipe Transaction', 'Swipe Transaction', 
                     'Chip Transaction', 'Swipe Transaction', 'Swipe Transaction',
                     'Chip Transaction', 'Online Transaction', 'Chip Transaction', 'Swipe Transaction'],
        ...
        'zip': [10001.0, 90001.0, 60601.0, 77001.0, 85001.0,
                10001.0, 90001.0, 60601.0, 77001.0, 85001.0],
...
@pytest.fixture(scope="session")
def temp_csv_file(tmp_path_factory: pytest.TempPathFactory, sample_data: pd.DataFrame) -> Path:
