...
class TestTransactionsService:
    ...
    def test_get_all_transactions_pagination(
    ...
    def test_get_all_transactions_second_page(
        self, service: TransactionsService
    ) -> None:
    ...
    def test_get_transaction_by_id_invalid_format(
        self, service: TransactionsService
    ) -> None:
    ...
    def test_get_transaction_by_id_invalid_letters(
        self, service: TransactionsService
    ) -> None:
    ...
    def test_search_multicriteria(self, service: TransactionsService) -> None:
        ...
        request = TransactionSearchRequest(type="CASH_OUT", isFraud=1)
    ...
    def test_search_with_amount_range(self, service: TransactionsService) -> None:
        ...
        request = TransactionSearchRequest(amount_range=[100.0, 10000.0])
        results = service.search_transactions(request)
    ...
    def test_search_with_empty_amount_range(self, service: TransactionsService) -> None:
        ...
        request = TransactionSearchRequest(
            type="PAYMENT", amount_range=[100.0]  # Seulement 1 élément
        )
        results = service.search_transactions(request)

        assert isinstance(results, list)

    def test_search_by_customer_id_as_destination(
        self, service: TransactionsService
    ) -> None:
        ...
        assert all(t.nameOrig == "C001" or t.nameDest == "C001" for t in results)
