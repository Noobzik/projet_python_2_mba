...
class TestDataLoaderCoverage:
    ...
    def test_load_data_invalid_csv_format(self, tmp_path: Path) -> None:
        ...
        with pytest.raises(ValueError, match="Erreur lors du chargement du fichier CSV"):
    ...
    def test_adapt_columns_unknown_use_chip_value(self, tmp_path: Path) -> None:
        ...
        csv_content = """id,date,client_id,card_id,amount,use_chip,merchant_id,merchant_city,merchant_state,zip,mcc,errors
